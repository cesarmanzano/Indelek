...
Public Class Ridgid
    ...
    Sub Pinta_URLs()
        ...
        loComando = Crea_SP("Indelek.dbo.Trae_URL_Sitio_Ridgid")
        ...
        Me.Image24.Attributes("AlternateText") = Valor(URLS, "url", 23).Trim
    ...
    Private Function Consulta_Menu() As DataSet
        ...
        Dim loLineas As New SqlDataAdapter("Consulta_Lineas_Web_Ridgid", loConexion)
        Dim loSubLineas As New SqlDataAdapter("Consulta_SubLineas_Web_Ridgid", loConexion)
        Dim loFamilias As New SqlDataAdapter("Consulta_Familias_Web_Ridgid", loConexion)
