...
<div>
    <div class="slider">
        <ul class="bxslider"> 
          <li> <a id="hrefImagen28" href="javascript:void(0)"> <asp:Image ID="Image28" ImageUrl="~/ImagenesRidgid/S1.jpg" runat="server" /></a></li>
          <li> <a id="hrefImagen29" href="javascript:void(0)"> <asp:Image ID="Image29" ImageUrl="~/ImagenesRidgid/S2.jpg" runat="server" /></a></li>
          <li> <a id="hrefImagen30" href="javascript:void(0)"> <asp:Image ID="Image30" ImageUrl="~/ImagenesRidgid/S3.jpg" runat="server" /></a></li>
          <li> <a id="hrefImagen31" href="javascript:void(0)"> <asp:Image ID="Image31" ImageUrl="~/ImagenesRidgid/S4.jpg" runat="server" /></a></li>
        </ul>
     </div>
